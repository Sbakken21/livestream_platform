                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <inertia-link :href="route('stream.index')">
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            <div class="ml-3 relative">
                                <div v-if="!$page.props.user">
                                    <inertia-link :href="route('login')" class="bg-indigo-700 rounded-lg px-4 py-2 hover:bg-indigo-800 font-semibold text-white">Login</inertia-link>
                                    <inertia-link :href="route('register')" class="bg-red-700 rounded-lg px-4 py-2 hover:bg-red-800 font-semibold text-white ml-2">Register</inertia-link>
                                </div>
                            </div>
